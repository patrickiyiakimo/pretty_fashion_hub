            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  {stats?.approved || partners.filter(p => normalizeStatus(p.status) === 'approved').length}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600">
                  {stats?.pending || partners.filter(p => normalizeStatus(p.status) === 'pending').length}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-600">
                  {stats?.rejected || partners.filter(p => normalizeStatus(p.status) === 'rejected').length}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {stats?.availableSlots || Math.max(0, 50 - partners.filter(p => normalizeStatus(p.status) === 'approved').length)}
                </p>
              </div>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {partners.map((partner) => {
                    const partnerStatus = normalizeStatus(partner.status);
                    return (
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex gap-3 pt-6 border-t border-gray-200">
            ...
            {normalizeStatus(partner.status) === 'suspended' && (
              <button
                onClick={() => onStatusUpdate('approved')}
                className="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors"
              >
