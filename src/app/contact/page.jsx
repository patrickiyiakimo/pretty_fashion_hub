      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 grid lg:grid-cols-2 gap-12">
        ...
        >
          ...
          <input
            ...
            className="rounded-xl bg-white/20 text-gray-700 backdrop-blur-sm px-6 py-3 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-400 transition"
          />
          <input
            type="email"
