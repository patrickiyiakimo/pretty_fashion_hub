    ...
    return (
      <section className="min-h-screen font-oswald bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center px-4 py-8 sm:py-20">
        ...
        >
          ...
          <Link
            href="/shop"
            className="inline-flex items-center text-white px-6 sm:px-8 py-3 sm:py-4 bg-orange-500 hover:bg-orange-400 transition-all duration-300 shadow-lg rounded-md"
          >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="pt-4 space-y-3">
                  <Link href="/checkout" className="block">
                    <button className="w-full bg-orange-500 hover:bg-orange-400 text-white py-4 px-6 rounded-xl font-semibold duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-3">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                      </svg>
                      Proceed to Checkout
