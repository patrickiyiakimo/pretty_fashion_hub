...
//             >
//               <div className="p-3 border-b border-gray-100 bg-orange-100">
...
export default function CheckoutPage() {
  ...
  // Auto-populate form with user data when available (same as profile page)
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate payment processing
    setTimeout(() => {
      toast.success(`Thank you ${formData.name}! Your order of ₦${total.toLocaleString()} has been received.`);
      setIsProcessing(false);
    }, 2000);
  };
    ...
    return (
      <section className="min-h-screen font-oswald bg-gradient-to-br from-gray-50 to-white flex items-center justify-center px-4 py-20">
        ...
        >
          ...
          <Link
            href="/shop"
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-orange-600 to-blue-600 text-white font-semibold rounded-lg hover:shadow-xl transition-all duration-300"
          >
            Continue Shopping
            <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
        ...
        {isAuthenticated && user && (
          ...
          >
            <p className="text-green-800">
              👋 Welcome back, <span className="font-semibold">{user.fullname || user.name || user.email}</span>! 
              Your information has been pre-filled for faster checkout.
            </p>
          </motion.div>
        )}
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden"
            >
              <div className="p-4 border-b border-gray-100 bg-orange-100">
                <h2 className="text-xl font-semibold text-gray-900 flex items-center gap-3">
                  <svg className="w-6 h-6 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-center gap-4 p-4 border border-gray-200 rounded-lg hover:border-orange-500 transition-colors cursor-pointer">
                  <input
                    type="radio"
                    name="paymentMethod"
                    value="card"
          ...
          <div className="lg:col-span-1">
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-lg border border-gray-100 sticky top-8"
            >
              <div className="p-6 border-b border-gray-100 bg-orange-100 rounded-t-2xl">
                <h2 className="text-xl font-semibold text-gray-900">Order Summary</h2>
              </div>
