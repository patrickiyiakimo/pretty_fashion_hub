...
//     image: "/images/Gemini_Generated_Image_kzivj7kzivj7kziv.png",
//     cta: "Explore Vendors",
...
export default function Hero() {
  return (
    <section className="relative h-screen min-h-[800px] lg:max-h-[70vh] overflow-hidden">
      {/* Static Background */}
      <div className="absolute inset-0">
        <Image
          src="/images/Gemini_Generated_Image_kzivj7kzivj7kziv.png"
        ...
        />
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/70 via-black/50 to-orange-900/70" />
      </div>
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            >
              ...
              {/* Description */}
              <p className="text-xl font-grotesk lg:text-2xl text-gray-200 leading-relaxed max-w-2xl">
              ...
              {/* Features */}
              <div className="flex flex-wrap font-grotesk items-center gap-6 pt-8 text-sm text-gray-300">
                <div className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
