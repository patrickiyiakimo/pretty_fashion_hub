  ...
  return (
    <section className="relative py-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-gradient-to-r from-amber-400/10 to-orange-500/10 rounded-full blur-3xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="relative">
          ...
          <div className="relative bg-white/80 backdrop-blur-xl rounded-4xl shadow-2xl shadow-gray-200/50 overflow-hidden border border-white/60">
            ...
            <div className="relative z-10 px-8 py-20 sm:px-16 sm:py-24 lg:px-20 lg:py-28">
              <div className="text-center max-w-5xl mx-auto">
                {/* Premium Badge */}
                <div className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200/60 rounded-2xl px-6 py-3 mb-12 backdrop-blur-sm shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex flex-col items-center text-center p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-gray-100/50 shadow-sm hover:shadow-lg transition-all duration-300 group hover:scale-105 hover:-translate-y-1"
                    >
                      <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center text-white shadow-lg mb-4 group-hover:scale-110 transition-transform duration-300">
                        {feature.icon}
                      </div>
                ...
                <div className="flex flex-col sm:flex-row gap-5 justify-center items-center mb-16">
                  {/* Primary Action */}
                  <Link href="/shop">
                    <button className="group relative bg-gradient-to-r from-gray-900 to-gray-800 text-white font-semibold px-12 py-5 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300 flex items-center gap-4 min-w-[240px] justify-center overflow-hidden hover:scale-105 hover:-translate-y-0.5">
                  ...
                  <Link href="/consultation">
                    <button className="group relative bg-white text-gray-900 font-semibold px-12 py-5 rounded-2xl border-2 border-gray-300 hover:border-gray-400 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-4 min-w-[240px] justify-center backdrop-blur-sm hover:scale-105 hover:-translate-y-0.5">
          ...
          <div className="absolute -top-6 -right-6 w-12 h-12 bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl shadow-2xl flex items-center justify-center animate-bounce">
            <HiSparkles className="w-6 h-6 text-white" />
          </div>
          
          <div className="absolute -bottom-8 -left-8 w-10 h-10 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl shadow-2xl animate-bounce delay-1000" />
        </div>
      </div>
    </section>
  );
