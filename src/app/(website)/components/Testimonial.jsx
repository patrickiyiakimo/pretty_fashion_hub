      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover why industry experts and fashion enthusiasts choose Vefiri for 
          ...
          <div className="bg-blue-600 rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
                Join thousands of satisfied customers who trust Vefiri for premium fashion that transforms.
              </p>
