...
//     { name: "Contact", href: "/contact" },
//     { name: "Partner", href: "/partner" },
//     { name: "Cart", href: "/cart", badge: cartCount, icon: <HiOutlineShoppingCart size={24} /> },
//     { name: "Log In", href: "/login" },
//   ];
...
//           <div className="relative w-10 h-10 rounded-full overflow-hidden border-2 border-yellow-400 group-hover:border-purple-400 transition-all duration-500">
//             <Image
//               src="/images/84712fed-7915-4ea9-a169-ce0c5d8b3531.JPG"
//               alt="kingz-world-logo"
//               fill
...
//         {/* Desktop Menu */}
//         <div className="hidden md:flex items-center space-x-10"> {/* Increased spacing */}
//           {navLinks.map((link) => (
//             <Link
//               key={link.name}
//               href={link.href}
//               className="relative text-yellow-300 hover:text-purple-400 font-medium text-lg tracking-wide group flex items-center px-3 py-2 transition-colors duration-300 rounded-lg hover:bg-black/20"
//             >
//               {/* Replace Cart text with icon */}
//               {/* {link.name === "Cart" ? (
//                 <div className="relative flex items-center justify-center">
//                   {link.icon}
//                   {link.badge > 0 && (
//                     <span className="absolute -top-2 -right-2 bg-yellow-400 text-purple-900 font-bold text-xs w-5 h-5 rounded-full flex items-center justify-center animate-pulse shadow-sm">
//                       {link.badge}
//                     </span>
//                   )}
//                 </div>
...
//               {link.name === "Cart" ? (
//   <div className="relative inline-flex"> {/* parent relative + inline-flex */}
//     {link.icon}
//     {link.badge > 0 && (
//       <span className="absolute -top-1 -right-1 bg-yellow-400 text-purple-900 font-bold text-xs w-5 h-5 rounded-full flex items-center justify-center animate-pulse shadow-sm">
//         {link.badge}
//       </span>
//     )}
//   </div>
...
//               href={link.href}
//               onClick={() => setIsOpen(false)}
//               className="flex items-center justify-between text-gray-100 font-medium text-lg hover:text-yellow-400 transition-colors duration-300 px-3 py-2 rounded-lg hover:bg-black/20"
//             >
//               <span>{link.name}</span>
//               {link.badge > 0 && (
//                 <span className="bg-yellow-400 text-purple-900 font-bold text-xs w-5 h-5 rounded-full flex items-center justify-center animate-pulse">
